...
{
    public class HTScrollBar : ScrollBar
    {
        #region 滑块默认颜色
        ...
        public static readonly DependencyProperty ThemeColorProperty =
            DependencyProperty.Register("ThemeColor", typeof(SolidColorBrush), typeof(HTScrollBar), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 200, 200, 200))));
        #endregion
        ...
        public static readonly DependencyProperty ThemeColorMouseOverProperty =
            DependencyProperty.Register("ThemeColorMouseOver", typeof(SolidColorBrush), typeof(HTScrollBar), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 180, 180, 180))));
        #endregion
        ...
        public static readonly DependencyProperty ThemeColorPressedProperty =
            DependencyProperty.Register("ThemeColorPressed", typeof(SolidColorBrush), typeof(HTScrollBar), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 190, 190, 190))));
        #endregion
        ...
        public static readonly DependencyProperty RadiusXProperty =
            DependencyProperty.Register("RadiusX", typeof(double), typeof(HTScrollBar), new PropertyMetadata(2.0));
        #endregion
        ...
        public static readonly DependencyProperty RadiusYProperty =
            DependencyProperty.Register("RadiusY", typeof(double), typeof(HTScrollBar), new PropertyMetadata(2.0));
        #endregion
        ...
        public static readonly DependencyProperty ScrollBarSizeProperty =
            DependencyProperty.Register("ScrollBarSize", typeof(double), typeof(HTScrollBar), new PropertyMetadata(6.0));
        #endregion
    }
}
