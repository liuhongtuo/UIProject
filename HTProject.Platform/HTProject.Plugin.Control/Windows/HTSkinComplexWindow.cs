...
namespace HTProject.Plugin.Control.Windows
{
    ...
    /// </summary>
    public class HTSkinComplexWindow : Window
    {
        #region 初始化
        public HTSkinComplexWindow()
        {
        ...
        public double HTWindowShadowSize
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.HTWindowShadowSize;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.HTWindowShadowSize = value;
                }
                else
                {
        ...
        public Color HTWindowShadowColor
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.HTWindowShadowColor;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.HTWindowShadowColor = value;
                }
                else
                {
        ...
        public Brush HTWindowShadowBackColor
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.HTWindowShadowBackColor;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.HTWindowShadowBackColor = value;
                }
                else
                {
